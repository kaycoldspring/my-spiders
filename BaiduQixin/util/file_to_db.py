...
from default_settings import redis_settings
from proxies import Proxies
from db import get_redis_cli
import re
...
def txt_to_db_with_re(file_name, redis_key):
	"""从文本文件中获取数据"""
...
def txt_to_db(file_name, redis_key):
	...
	with open(file_name, "r", encoding="utf-8", errors="ignore") as f:
		results = f.readlines()
		for i in results:
			redis_cli.lpush(redis_key, i.strip())
	print("save ok!")


if __name__ == '__main__':
	# txt_to_db_with_re(file_name=r"C:\Users\EDZ\Desktop\code\西瓜数据\shangbiao.txt", redis_key="tm_name")
	# csv_to_db()
	txt_to_db(file_name=r"C:\Users\EDZ\Desktop\code\百度企业信用\util\applicant.txt", redis_key="company_queue")