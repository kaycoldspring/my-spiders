...
fh = RotatingFileHandler("/data/logs/ina_click.log", maxBytes=1024*1024*100, backupCount=1)
...
#     'mongodb://{0}:{1}@dds-k1a4c899a7d43dd41.mongodb.ap-southeast-5.rds.aliyuncs.com:3717/'.format(username, password))
...
class InaClick(object):
    ...
    def send_requests(self, device_offer_id, ip, port, url, ua, device_ip):
        ...
        if device_offer_id:
            ...
            return 0
        # else:
        #     logger.info("Today's click has reached 300,000")
        #     return

    def get_offer_detect_data(self, offers_info):
        '''
        处理offer数组
